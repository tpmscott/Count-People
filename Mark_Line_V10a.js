...
async function Roll_Call_Search_V1a() { // Search from English Family Last Name
  ...
  if (Verse_32) {  // Fill data
     ...
     for (var i = 0; i < Verse_32.length ; i++) {
        ...
        Name_Str = '<a href="javascript:;" onclick="Show_People_Phone_V2(\'' + arg1 + '\');">' + Name_Str + '</a>';
...
}  // End of function Roll_Call_Search_V1a()
...
async function Roll_Call_V1(Arg) {  // Arg: 'R' for Roll Call, 'P' for Phone Dir.
  ...
  if (Verse_3) {
    ...
    //var tmp111 = '<a href="" ontouchstart="Set_NKJV();Set_One_Chap();Chinese_Mode3();Pre_Set_Mode();Set_Enter();keyFunction2(\'enter\');efocus();return false;">' + 'Chap ' + c_num + '</a>';
        ...
        //document.getElementById(Rnum++).style.font = "10px";

        //document.getElementById(Rvers++).style.font =  "20px";
...
async function Roll_Call_V2(Arg) {  // Arg: 'R' for Roll Call, 'P' for Phone Dir.
  ...
  if (Read_for_Roll_Call == 'N') {
   ...
   document.getElementById("content2").style.visibility='visible'; // hide
   document.getElementById("content2").style.height = "50%";
